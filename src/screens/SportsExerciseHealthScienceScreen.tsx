...
Assessment Outline and Weightings
...
(Total 50 marks)
Internal assessment (10 hours) - 24%
The internal assessment consists of one task: the scientific investigation.
This component is internally assessed by the teacher and externally moderated by the IB at the end of the course.
(Total 24 marks)

Assessment Outline HL
External assessment (4 hours and 15 minutes) - 76%
Paper 1 (1 hour and 45 minutes) - 36%
Paper 1A—Multiple-choice questions
Paper 1B—Data-based questions
(Total 65 marks)
Paper 2 (2 hours and 30 minutes) - 40%
Short-answer and extended-response questions
(Total 80 marks)
Internal assessment (10 hours) - 24%
The internal assessment consists of one task: the scientific investigation.
                    ...
                    <View style={{ backgroundColor: 'transparent' }}>
                      ...
                      {section.key === 'essentials' && (
                        <View>
                          ...
                          <Text style={{ ...themeStyles.subsectionTitle, fontFamily: 'ScopeOne-Regular', color: '#7EC3FF', marginTop: 16 }}>Assessment Outline and Weightings</Text>
                          ...
                          <View style={{ borderWidth: 1, borderColor: '#7EC3FF', borderRadius: 8, marginTop: 12, marginBottom: 8 }}>
                            ...
                            <View style={{ flexDirection: 'row', borderTopWidth: 1, borderColor: '#7EC3FF' }}>
                              ...
                              <Text style={{ flex: 1, color: '#B6B6B6', padding: 8, fontFamily: 'ScopeOne-Regular', textAlign: 'center', fontWeight: 'bold' }}>{highlightText('76%', highlightedText)}</Text>
                            </View>
                            ...
                            <View style={{ borderTopWidth: 1, borderColor: '#7EC3FF' }}>
                              ...
                              <View style={{ paddingLeft: 8, paddingRight: 8, paddingBottom: 8 }}>
                                ...
                                <Text style={{ color: '#B6B6B6', fontFamily: 'ScopeOne-Regular', marginBottom: 4 }}>{highlightText('Paper 1B—Data-based questions', highlightedText)}</Text>
                            ...
                            <View style={{ flexDirection: 'row', borderTopWidth: 1, borderColor: '#7EC3FF' }}>
                              <View style={{ flex: 3, padding: 8 }}>
                                ...
                                <Text style={{ color: '#B6B6B6', fontFamily: 'ScopeOne-Regular', marginBottom: 4 }}>{highlightText('Short-answer and extended-response questions', highlightedText)}</Text>
                                <Text style={{ color: '#B6B6B6', fontFamily: 'ScopeOne-Regular', fontStyle: 'italic' }}>{highlightText('(Total 50 marks)', highlightedText)}</Text>
                              </View>
                              <Text style={{ flex: 1, color: '#B6B6B6', padding: 8, fontFamily: 'ScopeOne-Regular', textAlign: 'center', fontWeight: 'bold' }}>{highlightText('40%', highlightedText)}</Text>
                            </View>
                            ...
                            <View style={{ flexDirection: 'row', borderTopWidth: 1, borderColor: '#7EC3FF' }}>
                              ...
                              <Text style={{ flex: 1, color: '#B6B6B6', padding: 8, fontFamily: 'ScopeOne-Regular', textAlign: 'center', fontWeight: 'bold' }}>{highlightText('24%', highlightedText)}</Text>
                            </View>
                          </View>
                          ...
                          <View style={{ borderWidth: 1, borderColor: '#7EC3FF', borderRadius: 8, marginTop: 12, marginBottom: 8 }}>
                            ...
                            {/* External assessment (4 hours and 15 minutes) */}
                            <View style={{ flexDirection: 'row', borderTopWidth: 1, borderColor: '#7EC3FF' }}>
                              <Text style={{ flex: 3, color: '#B6B6B6', padding: 8, fontFamily: 'ScopeOne-Regular', fontWeight: 'bold' }}>{highlightText('External assessment (4 hours and 15 minutes)', highlightedText)}</Text>
                              <Text style={{ flex: 1, color: '#B6B6B6', padding: 8, fontFamily: 'ScopeOne-Regular', textAlign: 'center', fontWeight: 'bold' }}>{highlightText('76%', highlightedText)}</Text>
                            </View>
                            ...
                            <View style={{ borderTopWidth: 1, borderColor: '#7EC3FF' }}>
                              <View style={{ flexDirection: 'row' }}>
                                <Text style={{ flex: 3, color: '#7EC3FF', padding: 8, fontFamily: 'ScopeOne-Regular', fontWeight: 'bold' }}>{highlightText('Paper 1 (1 hour and 45 minutes)', highlightedText)}</Text>
                                <Text style={{ flex: 1, color: '#B6B6B6', padding: 8, fontFamily: 'ScopeOne-Regular', textAlign: 'center', fontWeight: 'bold' }}>{highlightText('36%', highlightedText)}</Text>
                              </View>
                              <View style={{ paddingLeft: 8, paddingRight: 8, paddingBottom: 8 }}>
                                <Text style={{ color: '#B6B6B6', fontFamily: 'ScopeOne-Regular', marginBottom: 4 }}>{highlightText('Paper 1A—Multiple-choice questions', highlightedText)}</Text>
                                <Text style={{ color: '#B6B6B6', fontFamily: 'ScopeOne-Regular', marginBottom: 4 }}>{highlightText('Paper 1B—Data-based questions', highlightedText)}</Text>
                                <Text style={{ color: '#B6B6B6', fontFamily: 'ScopeOne-Regular', fontStyle: 'italic' }}>{highlightText('(Total 65 marks)', highlightedText)}</Text>
                              </View>
                            </View>
                            ...
                            <View style={{ flexDirection: 'row', borderTopWidth: 1, borderColor: '#7EC3FF' }}>
                              <View style={{ flex: 3, padding: 8 }}>
                                <Text style={{ color: '#7EC3FF', fontFamily: 'ScopeOne-Regular', fontWeight: 'bold', marginBottom: 4 }}>{highlightText('Paper 2 (2 hours and 30 minutes)', highlightedText)}</Text>
                                <Text style={{ color: '#B6B6B6', fontFamily: 'ScopeOne-Regular', marginBottom: 4 }}>{highlightText('Short-answer and extended-response questions', highlightedText)}</Text>
