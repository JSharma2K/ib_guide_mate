...
const MathAIScreen: React.FC<Props> = ({ navigation, route }) => {
  ...
  const sectionContentStrings: Record<'overview' | 'topics' | 'essentials' | 'rubrics' | 'mathematicsAI', string> = {
    ...
    rubrics: `External Assessment General Overview Grading guides are used to evaluate students in all exam papers. The grading guides are specific to each test session. External Assessment Details Standard Level General Information Paper One and Paper Two These exams are set and graded by external examiners. Together, they contribute 80% of the final grade for the course. These exams are designed to allow students to demonstrate what they know and what they can do. Paper One and Paper Two will contain some questions, or parts of questions, which are common with Higher Level. Calculators For both exam papers, students must have access to a graphic display calculator at all times. Regulations covering the types of calculators allowed are provided in assessment procedures. Formula booklet Each student must have access to a clean copy of the formula booklet during the exam. It is the responsibility of the school to download a copy and to ensure that there are sufficient copies available for all students. Grading of marks Points are awarded for method, accuracy, answers and reasoning, including interpretation. In Paper One and Paper Two, full points are not necessarily awarded for a correct answer with no working. Where an answer is incorrect, some points may be given for correct method, provided this is shown by written working. All students should therefore be advised to show their working. Paper One Duration 1 hour 30 minutes Weighting 40% This exam consists of mandatory short-response questions. Questions on this exam will vary in terms of length and level of difficulty. A calculator is required for this exam, but not every question will necessarily require its use. Individual questions will not be worth the same number of points. The points allocated are indicated at the start of each question. Content coverage Knowledge of all topics is required for this exam. However, not all topics are necessarily assessed in every test session. The intention of this exam is to test students knowledge and understanding across the breadth of the content. However, it should not be assumed that the separate topics are given equal emphasis. Point allocation This exam is worth 80 points, representing 40% of the final grade. Question type Questions of varying levels of difficulty are set. One or more steps may be needed to solve each question. Questions may be presented in the form of words, symbols, diagrams or tables, or combinations of these. Paper Two Duration 1 hour 30 minutes Weighting 40% This exam consists of mandatory extended-response questions. Questions on this exam will vary in terms of length and level of difficulty. A calculator is required for this exam, but not every question will necessarily require its use. Individual questions will not be worth the same number of points. The points allocated are indicated at the start of each question. Content coverage Knowledge of all topics is required for this exam. However, not all topics are necessarily assessed in every test session. The intention of this exam is to assess students knowledge and understanding of the content in depth. The range of topics tested in this exam may be narrower than that tested in Paper One. Point allocation This exam is worth 80 points, representing 40% of the final grade. Questions of varying levels of difficulty and length are set. Therefore, individual questions may not necessarily each be worth the same number of points. The exact number of points allocated to each question is indicated at the start of the question. Question type Questions require extended responses. Individual questions may require knowledge of more than one topic. Questions may be presented in the form of words, symbols, diagrams or tables, or combinations of these. Normally, each question reflects an incline of difficulty, from relatively easy tasks at the start of a question to relatively difficult tasks at the end of a question. The emphasis is upon sustained reasoning. External Assessment Details Higher Level General Information Paper One Paper Two and Paper Three These exams are set and graded by external examiners. Together, they contribute 80% of the final grade for the course. These exams are designed to allow students to demonstrate what they know and what they can do. Paper One and Paper Two will contain some questions, or parts of questions, which are common with Standard Level. Calculators For all three exam papers, students must have access to a calculator at all times. Regulations covering the types of calculators allowed are provided in assessment procedures. Formula booklet Each student must have access to a clean copy of the formula booklet during the exam. It is the responsibility of the school to download a copy and to ensure that there are sufficient copies available for all students. Grading of marks Points are awarded for method, accuracy, answers and reasoning, including interpretation. In Paper One, Paper Two and Paper Three, full points are not necessarily awarded for a correct answer with no working. Where an answer is incorrect, some points may be given for correct method, provided this is shown by written working. All students should therefore be advised to show their working. Paper One Duration 2 hours Weighting 30% This exam consists of mandatory short-response questions. Questions on this exam will vary in terms of length and level of difficulty. A calculator is required for this exam, but not every question will necessarily require its use. Individual questions will not be worth the same number of points. The points allocated are indicated at the start of each question. Content coverage Knowledge of all topics is required for this exam. However, not all topics are necessarily assessed in every test session. The intention of this exam is to test students knowledge and understanding across the breadth of the content. However, it should not be assumed that the separate topics are given equal emphasis. Point allocation This exam is worth 110 points, representing 30% of the final grade. Question type Questions of varying levels of difficulty are set. One or more steps may be needed to solve each question. Questions may be presented in the form of words, symbols, diagrams or tables, or combinations of these. Paper Two Duration 2 hours Weighting 30% This exam consists of mandatory extended-response questions. Questions on this exam will vary in terms of length and level of difficulty. A calculator is required for this exam, but not every question will necessarily require its use. Individual questions will not be worth the same number of points. The points allocated are indicated at the start of each question. Content coverage Knowledge of all topics is required for this exam. However, not all topics are necessarily assessed in every test session. The intention of this exam is to assess students knowledge and understanding of the content in depth. The range of topics tested in this exam may be narrower than that tested in Paper One. Point allocation This exam is worth 110 points, representing 30% of the final grade. Questions of varying levels of difficulty and length are set. Therefore, individual questions may not necessarily each be worth the same number of points. The exact number of points allocated to each question is indicated at the start of the question. Question type Questions require extended responses. Individual questions may require knowledge of more than one topic. Questions may be presented in the form of words, symbols, diagrams or tables, or combinations of these. Normally, each question reflects an incline of difficulty, from relatively easy tasks at the start of a question to relatively difficult tasks at the end of a question. The emphasis is upon sustained reasoning. Paper Three Duration 1 hour and 15 minutes Weighting 20% This exam consists of two mandatory extended-response problem-solving questions. A calculator is required for this exam, but not every question part will necessarily require its use. Content coverage Where possible, the first part of each question will be on content leading to the problem-solving context. Therefore, knowledge of all topics is required for this exam. Point allocation This exam is worth 55 points, representing 20% of the final grade. Questions may be unequal in terms of length and level of difficulty. Therefore, each question may not be worth the same number of points. The exact number of points allocated to each question is indicated at the start of each question. Question type Questions require extended responses involving sustained reasoning. Individual questions will develop from a single theme where the emphasis is on problem solving leading to a generalization or the interpretation of a context. Questions may be presented in the form of words, symbols, diagrams or tables, or combinations of these. Normally, each question reflects an incline in difficulty, from relatively easy at the start of a question to relatively difficult tasks at the end of the question. The emphasis is on problem solving. Internal Assessment Criteria SL and HL The investigation is internally assessed by the teacher and externally moderated using assessment criteria that relate to the objectives for mathematics. Each investigation is assessed against the following five criteria. The final mark for each investigation is the sum of the scores for each criterion. The maximum possible final mark is 20. Students will not receive a grade for their mathematics course if they have not submitted an investigation. Criterion A Presentation Criterion B Mathematical communication Criterion C Personal engagement Criterion D Reflection Criterion E Use of mathematics. Criterion A Presentation Achievement level 0 The investigation does not reach the standard described by the descriptors below. Achievement level 1 The investigation has some structure or some organization. Achievement level 2 The investigation has some structure and shows some organization. Achievement level 3 The investigation is structured and well organized. Achievement level 4 The investigation is structured, well organized, and concise. Criterion B Mathematical communication Achievement level 0 The investigation does not reach the standard described by the descriptors below. Achievement level 1 The investigation contains some relevant mathematical communication which is partially appropriate. Achievement level 2 The investigation contains some relevant appropriate mathematical communication. Achievement level 3 The mathematical communication is relevant, appropriate and is mostly consistent. Achievement level 4 The mathematical communication is relevant, appropriate and consistent throughout. Criterion C Personal engagement Achievement level 0 The investigation does not reach the standard described by the descriptors below. Achievement level 1 There is evidence of some personal engagement. Achievement level 2 There is evidence of significant personal engagement. Achievement level 3 There is evidence of outstanding personal engagement. Criterion D Reflection Achievement level 0 The investigation does not reach the standard described by the descriptors below. Achievement level 1 There is evidence of limited reflection. Achievement level 2 There is evidence of meaningful reflection. Achievement level 3 There is substantial evidence of critical reflection. Criterion E Use of mathematics SL Achievement level 0 The investigation does not reach the standard described by the descriptors below. Achievement level 1 Some relevant mathematics is used. Achievement level 2 Some relevant mathematics is used. Limited understanding is demonstrated. Achievement level 3 Relevant mathematics appropriate with the level of the course is used. Limited understanding is demonstrated. Achievement level 4 Relevant mathematics appropriate with the level of the course is used. The mathematics investigated is partially correct. Some knowledge and understanding are demonstrated. Achievement level 5 Relevant mathematics appropriate with the level of the course is used. The mathematics investigated is mostly correct. Good knowledge and understanding are demonstrated. Achievement level 6 Relevant mathematics appropriate with the level of the course is used. The mathematics investigated is correct. Thorough knowledge and understanding are demonstrated. Criterion E Use of mathematics HL Achievement level 0 The investigation does not reach the standard described by the descriptors below. Achievement level 1 Some relevant mathematics is used. Limited understanding is demonstrated. Achievement level 2 Some relevant mathematics is used. The mathematics investigated is partially correct. Some knowledge and understanding is demonstrated. Achievement level 3 Relevant mathematics appropriate with the level of the course is used. The mathematics investigated is correct. Some knowledge and understanding are demonstrated. Achievement level 4 Relevant mathematics appropriate with the level of the course is used. The mathematics investigated is correct. Good knowledge and understanding are demonstrated. Achievement level 5 Relevant mathematics appropriate with the level of the course is used. The mathematics investigated is correct and demonstrates sophistication or rigour. Thorough knowledge and understanding are demonstrated. Achievement level 6 Relevant mathematics appropriate with the level of the course is used. The mathematics investigated is precise and demonstrates sophistication and rigour. Thorough knowledge and understanding are demonstrated.`,
                ...
                <View style={{ paddingHorizontal: 20, paddingBottom: 16 }}>
                  {renderAnimatedContent(section.key, (
                    <View style={{ backgroundColor: 'rgba(24,26,32,0.92)', borderRadius: 12, padding: 16, marginTop: 8 }}>
                      ...
                      {section.key === 'rubrics' && (
                        <View>
                          <Text style={{ ...themeStyles.subsectionTitle, fontFamily: 'ScopeOne-Regular', color: '#7EC3FF' }}>External Assessment</Text>
                          
                          <Text style={{ ...themeStyles.content, fontFamily: 'ScopeOne-Regular', color: '#FFFFFF', lineHeight: 22, marginBottom: 16 }}>
                            {highlightText('Grading guides are used to evaluate students in all exam papers. The grading guides are specific to each test session.', highlightedText)}
                          </Text>
                          
                          <Text style={{ ...themeStyles.levelTitle, color: '#7EC3FF', fontFamily: 'ScopeOne-Regular', marginTop: 12, marginBottom: 8 }}>Standard Level</Text>
                          
                          <Text style={{ ...themeStyles.content, fontFamily: 'ScopeOne-Regular', color: '#FFFFFF', lineHeight: 22, marginBottom: 12 }}>
                            {highlightText('Paper One and Paper Two are set and graded by external examiners. Together, they contribute 80% of the final grade for the course. These exams are designed to allow students to demonstrate what they know and what they can do.', highlightedText)}
                          </Text>
                          
                          <View style={{ borderWidth: 1, borderColor: '#7EC3FF', borderRadius: 8, marginBottom: 16 }}>
                            <View style={{ flexDirection: 'row', backgroundColor: 'rgba(182,199,247,0.18)' }}>
                              <Text style={{ ...themeStyles.sectionTitle, fontFamily: 'ScopeOne-Regular', color: '#7EC3FF', flex: 1, padding: 8 }}>Paper</Text>
                              <Text style={{ ...themeStyles.sectionTitle, fontFamily: 'ScopeOne-Regular', color: '#7EC3FF', flex: 1, padding: 8 }}>Duration</Text>
                              <Text style={{ ...themeStyles.sectionTitle, fontFamily: 'ScopeOne-Regular', color: '#7EC3FF', flex: 1, padding: 8 }}>Weighting</Text>
                              <Text style={{ ...themeStyles.sectionTitle, fontFamily: 'ScopeOne-Regular', color: '#7EC3FF', flex: 1, padding: 8 }}>Points</Text>
                            </View>
                            
                            <View style={{ flexDirection: 'row', borderTopWidth: 1, borderColor: '#7EC3FF' }}>
                              <Text style={{ flex: 1, color: '#B6B6B6', padding: 8, fontFamily: 'ScopeOne-Regular' }}>{highlightText('Paper One', highlightedText)}</Text>
                              <Text style={{ flex: 1, color: '#B6B6B6', padding: 8, fontFamily: 'ScopeOne-Regular' }}>{highlightText('1h 30m', highlightedText)}</Text>
                              <Text style={{ flex: 1, color: '#B6B6B6', padding: 8, fontFamily: 'ScopeOne-Regular' }}>{highlightText('40%', highlightedText)}</Text>
                              <Text style={{ flex: 1, color: '#B6B6B6', padding: 8, fontFamily: 'ScopeOne-Regular' }}>{highlightText('80', highlightedText)}</Text>
                            </View>
                            
                            <View style={{ flexDirection: 'row', borderTopWidth: 1, borderColor: '#7EC3FF' }}>
                              <Text style={{ flex: 1, color: '#B6B6B6', padding: 8, fontFamily: 'ScopeOne-Regular' }}>{highlightText('Paper Two', highlightedText)}</Text>
                              <Text style={{ flex: 1, color: '#B6B6B6', padding: 8, fontFamily: 'ScopeOne-Regular' }}>{highlightText('1h 30m', highlightedText)}</Text>
                              <Text style={{ flex: 1, color: '#B6B6B6', padding: 8, fontFamily: 'ScopeOne-Regular' }}>{highlightText('40%', highlightedText)}</Text>
                              <Text style={{ flex: 1, color: '#B6B6B6', padding: 8, fontFamily: 'ScopeOne-Regular' }}>{highlightText('80', highlightedText)}</Text>
                            </View>
                          ...
                          <Text style={{ ...themeStyles.content, fontFamily: 'ScopeOne-Regular', color: '#FFFFFF', lineHeight: 22, marginBottom: 12 }}>
                            {highlightText('Paper One consists of mandatory short-response questions. Paper Two consists of mandatory extended-response questions. Both papers require a graphic display calculator and access to the formula booklet.', highlightedText)}
                          </Text>
                          
                          <Text style={{ ...themeStyles.levelTitle, color: '#7EC3FF', fontFamily: 'ScopeOne-Regular', marginTop: 16, marginBottom: 8 }}>Higher Level</Text>
                          
                          <Text style={{ ...themeStyles.content, fontFamily: 'ScopeOne-Regular', color: '#FFFFFF', lineHeight: 22, marginBottom: 12 }}>
                            {highlightText('Paper One, Paper Two and Paper Three are set and graded by external examiners. Together, they contribute 80% of the final grade for the course.', highlightedText)}
                          </Text>
                          ...
                          <View style={{ borderWidth: 1, borderColor: '#7EC3FF', borderRadius: 8, marginBottom: 16 }}>
                            ...
                            <View style={{ flexDirection: 'row', borderTopWidth: 1, borderColor: '#7EC3FF' }}>
                              <Text style={{ flex: 1, color: '#B6B6B6', padding: 8, fontFamily: 'ScopeOne-Regular' }}>{highlightText('Paper One', highlightedText)}</Text>
                              <Text style={{ flex: 1, color: '#B6B6B6', padding: 8, fontFamily: 'ScopeOne-Regular' }}>{highlightText('2h', highlightedText)}</Text>
                              <Text style={{ flex: 1, color: '#B6B6B6', padding: 8, fontFamily: 'ScopeOne-Regular' }}>{highlightText('30%', highlightedText)}</Text>
                              <Text style={{ flex: 1, color: '#B6B6B6', padding: 8, fontFamily: 'ScopeOne-Regular' }}>{highlightText('110', highlightedText)}</Text>
                            </View>
                            ...
                            <View style={{ flexDirection: 'row', borderTopWidth: 1, borderColor: '#7EC3FF' }}>
                              <Text style={{ flex: 1, color: '#B6B6B6', padding: 8, fontFamily: 'ScopeOne-Regular' }}>{highlightText('Paper Three', highlightedText)}</Text>
                              <Text style={{ flex: 1, color: '#B6B6B6', padding: 8, fontFamily: 'ScopeOne-Regular' }}>{highlightText('1h 15m', highlightedText)}</Text>
                              <Text style={{ flex: 1, color: '#B6B6B6', padding: 8, fontFamily: 'ScopeOne-Regular' }}>{highlightText('20%', highlightedText)}</Text>
                              <Text style={{ flex: 1, color: '#B6B6B6', padding: 8, fontFamily: 'ScopeOne-Regular' }}>{highlightText('55', highlightedText)}</Text>
                            </View>
                          </View>
                          
                          <Text style={{ ...themeStyles.content, fontFamily: 'ScopeOne-Regular', color: '#FFFFFF', lineHeight: 22, marginBottom: 12 }}>
                            {highlightText('Paper Three consists of two mandatory extended-response problem-solving questions. The emphasis is on problem solving leading to a generalization or the interpretation of a context.', highlightedText)}
                          </Text>
                          
                          <Text style={{ ...themeStyles.subsectionTitle, fontFamily: 'ScopeOne-Regular', color: '#7EC3FF', marginTop: 24, marginBottom: 8 }}>Assessment Guidelines</Text>
                          
                          <Text style={{ ...themeStyles.content, fontFamily: 'ScopeOne-Regular', color: '#FFFFFF', lineHeight: 22, marginBottom: 16 }}>
                            {highlightText('Points are awarded for method, accuracy, answers and reasoning, including interpretation. Full points are not necessarily awarded for a correct answer with no working. Where an answer is incorrect, some points may be given for correct method, provided this is shown by written working.', highlightedText)}
                          </Text>
